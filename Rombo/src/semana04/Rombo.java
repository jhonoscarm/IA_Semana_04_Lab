...
public class Rombo extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		double dMay, dMen, area;
		
		dMay = Double.parseDouble(txtDiagonalMayor.getText());
		dMen = Double.parseDouble(txtDiagonalMenor.getText());
		
		area = (dMay * dMen) / 2;
		
		txtS.setText("Área : " + decimalFormat(area));
